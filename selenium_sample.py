...
url2="https://s3.console.aws.amazon.com/s3/buckets/bw-ea-revenuemanager-qs/Medallia/?region=us-west-2&tab=overview"
driver.get(url2)
#driver.get(url)
driver.find_element_by_id("resolving_input").send_keys("bestwestern-analytics")
driver.find_element_by_id("next_button").click()
driver.find_element_by_id("username").send_keys("purushv")
driver.find_element_by_id ('password').send_keys("Vikivigo@007")
...
driver.find_element_by_id("uploadInput").send_keys("C:/Users/purushv/Downloads/Medallia/12_Months_Ranker.xls")
time.sleep(2)
for i in range(3):
